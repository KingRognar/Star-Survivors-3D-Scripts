...
public class UpgradeSystem_Scr : MonoBehaviour
{
    ...
    public List<UpgradeTree_SO> upgradeTrees = new (); //TODO: добавл€ем, когда получаем новое оружие/ выбираем новый апгрейд
    public List<bool[]> upgradeUnlockTracker = new List<bool[]> (); //TODO: нужно засел€ть лист
    ...
    private void OpenLvlUpMenu() //TODO: переписать под новый UI
    {
        ...
        List<GenericUpgrade_SO> possibleUpgrades = GetPossibleUpgrades(); //TODO: нужно ещЄ как-то получать UpgradeTree_SO
